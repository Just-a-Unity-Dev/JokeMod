...
public class TrollBookItem extends JokemodModElements.ModElement {
	@ObjectHolder("jokemod:troll_book")
	public static final Item block = null;
	public TrollBookItem(JokemodModElements instance) {
		super(instance, 8);
	}
