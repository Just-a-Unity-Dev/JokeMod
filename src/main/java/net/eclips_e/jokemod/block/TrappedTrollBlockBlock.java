...
public class TrappedTrollBlockBlock extends JokemodModElements.ModElement {
	@ObjectHolder("jokemod:trapped_troll_block")
	public static final Block block = null;
	public TrappedTrollBlockBlock(JokemodModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("trapped_troll_block");
		}
