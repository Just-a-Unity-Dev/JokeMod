...
package net.eclips_e.jokemod.command;
...
public class FreeDiamondsCommand extends JokemodModElements.ModElement {
	public FreeDiamondsCommand(JokemodModElements instance) {
		super(instance, 5);
	...
	private LiteralArgumentBuilder<CommandSource> customCommand() {
		return LiteralArgumentBuilder.<CommandSource>literal("coordinates")
